...
<head>
<meta charset="UTF-8">
<title>Roblox Advanced Async Scanner</title>
<style>
...
pre{background:#111;padding:15px;border-radius:12px;max-height:500px;overflow:auto;border:2px solid #333;}
...
<textarea id="ids" placeholder="Paste asset/place/universe IDs here (comma or newline)"></textarea>
<br>
